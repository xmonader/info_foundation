...
* [Why opensource and open license?](open_license_strategy.md)
* [Values](goals_values.md)
    * [FreeFlow Nation Manifesto](https://www.freeflownation.org/manifesto.html)
    * [Personal Note On Values For Creating A Better World Through Collaboration](kristof_build_a_better_world_values_collaboration.md)
    * [IQ_EQ_SQ](IQ_EQ_SQ.md)
    * [Ethical Design of Products Or Services](ethical_design_manifesto.md)
    * [responsive organization manifesto (connected world)](responsive_org_manifesto.md)
